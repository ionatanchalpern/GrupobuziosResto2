function configControls() {
    ...
    $("#grid").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "preciosServicios.aspx/Get", //specify the URL which data should return the records. This is the Read method of the Products.asmx service.
    ...
    $("#grid").delegate(".editColumn", "click", function (e) {
        ...
        window.location.href = "preciosServiciose.aspx?Mode=E&Id=" + dataItem.IDPrecioServicio;
    });
...
function nuevo() {
    window.location.href = "preciosServiciose.aspx?Mode=A";
}
