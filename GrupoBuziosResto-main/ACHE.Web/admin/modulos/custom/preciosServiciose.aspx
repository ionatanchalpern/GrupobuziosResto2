<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="preciosServiciose.aspx.cs" Inherits="admin_modulos_custom_preciosServiciose" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li>
                   ...
                   <%-- <li>
                        <label class="fldTitle"><abbr class="require">*</abbr>Precio Regular NO Representado <br /><small>Ingrese 0 para ocultarlo</small></label>
                        <div class="fieldwrap">
                           <asp:TextBox runat="server" ID="txtPrecioRegularNR" CssClass="form-control numeric" />
                           <asp:RequiredFieldValidator ClientIDMode="Static" runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtPrecioRegularNR"
                                ErrorMessage="Este campo es obligatorio." CssClass="errorRequired" Display="Dynamic" />
                        </div>
                    </li>--%>
                    <li>
                   ...
                   <%-- <li>
                        <label class="fldTitle"><abbr class="require">*</abbr>Precio Privado NO Representado <br /><small>Ingrese 0 para ocultarlo</small></label>
                        <div class="fieldwrap">
                           <asp:TextBox runat="server" ID="txtPrecioPrivadoNR" CssClass="form-control numeric" />
                           <asp:RequiredFieldValidator ClientIDMode="Static" runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtPrecioPrivadoNR"
                                ErrorMessage="Este campo es obligatorio." CssClass="errorRequired" Display="Dynamic" />
                        </div>
                    </li>--%>
                    <li>
