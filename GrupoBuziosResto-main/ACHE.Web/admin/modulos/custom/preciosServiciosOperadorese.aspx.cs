...
public partial class admin_modulos_custom_preciosServiciosOperadorese : AdminBasePage
{
    #region Properties
    ...
    private void cargarCombos()
    {
        using (var dbContext = new ACHEEntities())
        {
            ...
            //int idOperador = int.Parse(cmbOperador.SelectedValue);
    ...
    protected void btnAceptar_OnClick(object sender, EventArgs e)
    {
        if (IsValid == true)
        {
            Response.Redirect("preciosServiciosOperadores.aspx");
        }
    }
    ...
    private void LoadEntity()
    {
        using (var dbContext = new ACHEEntities())
        {
            var entity = dbContext.PreciosServicios.Include("Usuarios").Where(x => x.IDPrecioServicio == this.idEntidad).FirstOrDefault();
            if (entity != null)
            {
                cmbOperador.SelectedValue = entity.IDUsuario.ToString();
                ...
                //txtObservacionesNeto.Text = entity.ObservacionesRegular;
                ...
                //txtPrecioNeto.Text = entity.PrecioRegular.ToString();
            }
            else
    ...
    private void CreateEntity()
    {
        using (var dbContext = new ACHEEntities())
        {
            ...
            entity.IDUsuario = int.Parse(cmbOperador.SelectedValue);
            ...
            //entity.ImporteNeto = decimal.Parse(txtPrecioNeto.Text);
            //entity.ObservacionesNeto = txtObservacionesNeto.Text;
            ...
            {
                var precioAnt = dbContext.PreciosServicios.Where(x => x.IDServicio == entity.IDServicio && x.IDUsuario != null && x.IDUsuario == entity.IDUsuario && (x.FechaHasta >= entity.FechaDesde && x.FechaDesde <= entity.FechaHasta)).FirstOrDefault();
                if (precioAnt != null)
                    isValid = false;
            }
            if (isValid)
