<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="preciosServicios.aspx.cs" Inherits="admin_modulos_custom_preciosServicios" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" Runat="Server">
        Admin :: Precios por Servicio

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
        <script type="text/javascript" src="<%= ResolveUrl("~/admin/js/views/custom/PreciosServicios.js?v=1") %>"></script>

</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
       <div class="container_12">
		<h4>Administración de Precios por Servicio</h4>
		<div class="form-grid">
			<br />
