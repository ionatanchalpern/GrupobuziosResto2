<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageFront.master" AutoEventWireup="true" CodeFile="traslados-paso3.aspx.cs" Inherits="traslados_paso3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="css/traslados-pasos.css?v=1" rel="stylesheet" />
    <%--<script type="text/javascript" src="js/lightbox.min.js"></script>--%>
    <script type="text/javascript" src="<%= ResolveUrl("~/js/traslados-paso3.js?v=3.6") %>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
      ...
      <div id="MainContent_pnlCarrito">
        ...
        <input type="hidden" name="ctl00$MainContent$hdnIDSubTipo" id="hdnSubTipo" value="0" />
        <div class="container content-padding traslados">
		  ...
		  <div class="formularios-steps text-center clearfix">
            ...
            <div class="col-xs-12 traslados-mods-title">
             ...
             <!--       <input  runat="server" value="ida" name="idayvuelta" type="radio"  id="soloida" group="idaovuelta"  ClientIDMode="static"/>
                <label for="soloida">Ida y Vuelta</label>-->


   
         
     <!--       <asp:Panel runat="server" ID="pnlRoundTrip" Visible="false">
          
                <h4>Seleccione el tramo:
                <input value="ida" name="idayvuelta" type="radio"  group="idaovuelta" />
                <label for="soloida">Sólo Ida</label>

                <input value="vuelta" name="idayvuelta" type="radio" id="Radio2" group="idaovuelta" />
                <label for="solovuelta">Sólo Vuelta</label>
              </h4>
            </asp:Panel> -->
            </div>
            <asp:panel runat="server" ID="pnlIda" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 data traslados-data ida"  Visible="false">
  	          <div  class="col-xs-12 name date no-border no-bottom-padding">
                    ...
                    <asp:TextBox runat="server" id="txtFechaIda" class="datepicker-input" placeholder="DD/MM/AA" ClientIDMode="static"></asp:TextBox>
                        <span id="spnFechaIda" class="errorRequired"></span><br />
              </div>
                <asp:Panel runat="server" id="pnlAeropuertoIda"  Visible="false">
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 origin">
  	                <h1 class="neutral">Aeropuerto</h1>
                         <span class="select-default">
                            ...
                            <span id="spnAeropuertoIda" class="errorRequired"></span><br />
  	              </div>
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 arrival">
  	                ...
  	                <h3>Compañía aérea</h3>
  	                 <asp:TextBox runat="server" id="txtCompaniaAerea"  ClientIDMode="static"></asp:TextBox>
                            <span id="spnCompaniaAerea" class="errorRequired"></span><br />
  	              </div>
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 arrival">
  	                ...
  	                <h3>Nº de vuelo</h3>
                            ...
                            <span id="spnNroVuelo" class="errorRequired"></span><br />
  	              </div>
  	              ...
  	              <div class="clearfix"></div>
                   <br />
                <asp:Panel runat="server" ID="pnlHotelIda"  Visible="false">
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 destination">
  	                <h2><span runat="server" id="spnHotelIda"/></h2>
  	              </div>
                    ...
                    <asp:TextBox runat="server" id="txtNombreHotelIda"  placeholder="Nombre del Hotel" ClientIDMode="static"></asp:TextBox>
                            <span id="spnNombreHotelIda" class="errorRequired"></span><br />
  	              </div>
                   ...
                   <br />   
                <asp:Panel runat="server" ID="pnlHotelIda2"  Visible="false" >
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 destination">
                           <br />
                          <h2><span runat="server" id="spnHotelIda2"/></h2>
  	              </div>

  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 destination">
                    <asp:TextBox runat="server" id="txtNombreHotelIda2"  placeholder="Nombre del Hotel" ClientIDMode="static"></asp:TextBox>
                            <span id="spnNombreHotelIda2" class="errorRequired"></span><br />
  	              </div>
            ...
            <asp:Panel ID="pnlVuelta" runat="server" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 data traslados-data last vuelta" Visible="false">
                ...
                <h1 class="super">Vuelta</h1>
  	            <h1 class="sub">Fecha Vuelta (Out) <!--span style="color:#e74c48">Atención: Fecha de SALIDA del aéreo</span--></h1>
                    ...
                    <span id="spnFechaVuelta" class="errorRequired"></span><br />
  	          </div>
                <asp:Panel runat="server" id="pnlAeropuertoVuelta"  Visible="false">
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 origin">
  	                <h1 class="neutral">Aeropuerto</h1>
                         <span class="select-default">
                            ...
                            <span id="spnAeropuertoVuelta" class="errorRequired"></span><br />
  	              </div>
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 arrival">
  	                <h2 class="no-margin">&nbsp;</h2>
  	                <h3>Compañía aérea</h3>
  	                 <asp:TextBox runat="server" id="txtCompaniaVuelta"  ClientIDMode="static"></asp:TextBox>
                            <span id="spnCompaniaVuelta" class="errorRequired"></span><br />
  	              </div>
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 arrival">
  	                <h2 class="no-margin">&nbsp;</h2>
  	                <h3>Nº de vuelo</h3>
                            <asp:TextBox runat="server" id="txtNroVueloVuelta"  ClientIDMode="static"></asp:TextBox>
                            <span id="spnNroVueloVuelta" class="errorRequired"></span><br />
  	              </div>
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 arrival">
  	                <h2 class="no-margin">&nbsp;</h2>
                ...
                <div class="clearfix"></div>
                   <br />
                <asp:Panel runat="server" ID="pnlHotelVuelta"  Visible="false">
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 destination">
  	                <h2><span runat="server" id="spnHotelVuelta"/></h2>
  	              </div>

  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 destination">
                    <asp:TextBox runat="server" id="txtNombreHotelVuelta"  placeholder="Nombre del Hotel" ClientIDMode="static"></asp:TextBox>
                            <span id="spnNombreHotelVuelta" class="errorRequired"></span><br />
  	              </div>
                    ...
                    <asp:TextBox runat="server" id="txtDireccionHotelVuelta"  placeholder="Dirección del Hotel" ClientIDMode="static"></asp:TextBox>
                      ...
                      <br />
                <asp:Panel runat="server" ID="pnlHotelVuelta2"  Visible="false">
  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 destination">
                           <br />
  	                <h2><span runat="server" id="spnHotelVuelta2"/></h2>
  	              </div>

  	              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 destination">
                    <asp:TextBox runat="server" id="txtNombreHotelVuelta2"  placeholder="Nombre del Hotel" ClientIDMode="static"></asp:TextBox>
                            <span id="spnNombreHotelVuelta2" class="errorRequired"></span><br />
  	              </div>
            ...
            <div class="col-xs-12 border-top-purple">
  	          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 destination last">
  	            ...
  	            <asp:TextBox runat="server" TextMode="multiline" ClientIDMode="Static" Rows="5"  id="txtObservaciones"></asp:TextBox>
  	          </div>
